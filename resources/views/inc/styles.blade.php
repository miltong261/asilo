<link href="{{ asset('assets/css/loader.min.css') }}" rel="stylesheet" type="text/css" />
...
<link  href="{{ asset('assets/css/styles-vue.css') }}" rel="stylesheet">
<!-- END GLOBAL MANDATORY STYLES -->

<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->

<link href="{{ asset('assets/css/dash_1.min.css') }}" rel="stylesheet" type="text/css" />
