                        ...
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"><i class="fas fa-phone-alt"></i> Teléfono</th>
                                    <th class="text-center"><i class="fas fa-street-view"></i> Dirección</th>
                                    <th class="text-center"><i class="fas fa-cogs"></i> Opciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(donante, index) in lista_donantes " :key="donante.id">
                                    <td v-text="index+1" class="text-center"></td>
                                    <td v-text="donante.nombre" class="text-center"></td>
                                    <td v-text="donante.telefono" class="text-center"></td>
                                    <td v-text="donante.direccion" class="text-center"></td>
                                    <td class="text-center">
                                        <button type="button" @click="openModal('update', donante)" class="btn btn-warning mb-2 mr-2 rounded-circle"> <i class="fas fa-sync-alt"></i></button>
                        ...
                        <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate action="javascript:void(0)">
                            <div class="form-row mb-0">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input  @keyup.enter="store()" type="text" v-model="telefono" class="form-control" :class="hasError('telefono') ? 'is-invalid' : ''" name="telefono">
                            ...
                            <div class="form-row mb-0">
                                <div class="form-group col-md-12">
                                    ...
                                    <input  @keyup.enter="store()" type="text" v-model="direccion" class="form-control" :class="hasError('direccion') ? 'is-invalid' : ''" name="direccion">
        ...
        methods: {
            openModal(metodo, data = []) {
                switch(metodo){
                    case 'create': {
                        this.modal = 1
                        this.titulo = "Registro de donantes"
                        this.opcion = 1
                        break
                    }
                    case 'update': {
                        this.modal = 2
                        this.titulo = "Actualización de donantes"
                        this.opcion = 2
            ...
            showList() {
                ...
                axios.get(url).then(function (response) {
                    me.lista_donantes = response.data
                    me.dataTable();
                })
