                        ...
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"> <i class="fas fa-file-alt"></i> Nombre</th>
                            ...
                            <tbody>
                                 <tr >
                                    ...
                                    <td class="text-center">
                                        <button type="button" @click="openModal('update', donaciones)" class="btn rounded-circle btn-warning mb-2"> <i class="fas fa-sync-alt"></i></button>
                    ...
                    <div class="form-group row col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label> <i class="fas fa-calendar-alt"></i> Fecha donación</label>
                               <input type="date" class="form-control" name="fecha_donacion" v-model="fecha_donacion" placeholder="fecha_nacimiento">              
                          </div>
                        </div>

                         <div class="col-md-6">
                            <div class="form-group">
                                 <label> <i class="fas fa-file-alt"></i> Donante </label>
                               <input type="text" class="form-control" name="donante" v-model="donante" placeholder="Donante">      
                          </div>
                        </div>
                    </div>
