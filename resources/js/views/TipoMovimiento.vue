<template>
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            ...
            <button type="button" @click="openModal('create')" class="btn btn-info mb-2">Nuevo <i class="fas fa-file-alt"></i></button>
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive mb-0 mt-0">
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                <tr v-for="(tipo_movimiento, index) in lista_tipo_movimiento " :key="tipo_movimiento.id">
                                    <td v-text="index+1" class="text-center"></td>
                                    <td v-text="tipo_movimiento.codigo" class="text-center"></td>
                                    <td v-text="tipo_movimiento.nombre" class="text-center"></td>
                                    <td class="text-center">
                                        <div v-if="tipo_movimiento.entrada">
                                    ...
                                    <td class="text-center">
                                        <div v-if="tipo_movimiento.salida">
                                            <span class="badge outline-badge-check"><i class="fa fa-check-circle"></i></span>
                                        </div>
                                        <div v-else>
                                            <span class="badge outline-badge-no-check"><i class="fa fa-times-circle"></i></span>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <template v-else-if="tipo_movimiento.estado==0 && (tipo_movimiento.id!=1 && tipo_movimiento.id!=2)">
    ...
    methods: {
        ...
        changeStatus(action, id, nombre) {
            swal({
                ...
                if (action == 'activate')
                    var url = '/tipo_movimiento/activate'
                else if (action == 'desactivate')
                    var url = '/tipo_movimiento/desactivate'
