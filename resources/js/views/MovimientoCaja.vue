                        ...
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"><i class="fas fa-money-bill"></i> Monto</th>
                            ...
                            <tbody>
                                <tr v-for="(movimiento, index) in lista_movimiento" :key="movimiento.id">
                                    ...
                                    <td v-text="movimiento.tipo_movimiento_id" class="text-center"></td>
                                    <td v-text="movimiento.monto" class="text-center"></td>
                        ...
                        <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate action="javascript:void(0)">
                            <div class="form-row mb-0">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" v-model="tipo_movimiento_id">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="monto" v-model="monto" class="form-control">
                                </div>

                                <div class="form-group col-md-12">
                                    <label class="text-dark"><i class="fas fa-search"></i> Observación</label>
                                    <input type="text" name="observacion" v-model="observacion" class="form-control">
                                </div>
                            </div>
                        </form>
                    </div>
