                        ...
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                <tr v-for="(ajuste_producto, index) in lista_ajuste_producto" :key="ajuste_producto.id">
                                    ...
                                    <td class="text-center">
                                        <div v-if="ajuste_producto.salida">
                                            <span class="badge outline-badge-check"><i class="fa fa-check-circle"></i></span>
                                        </div>
                                        <div v-else>
                                            <span class="badge outline-badge-no-check"><i class="fa fa-times-circle"></i></span>
                                    ...
                                    <td v-text="ajuste_producto.nombre_usuario" class="text-center"></td>
                                    <td class="text-center">
                    ...
                    <div class="modal-body">
                        <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate action="javascript:void(0)">
                            ...
                            <div class="form-row mb-2">
                                <div class="form-group col-md-12">
                                    <label class="text-dark"><i class="fas fa-search"></i> Justificación</label>
                        ...
                        <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate action="javascript:void(0)">
                            ...
                            <div class="form-row mb-0">
                                <div class="form-group col-md-6">
                                    <label><i class="fas fa-store"></i> Nombre del producto</label>
...
export default {
    ...
    methods: {
        ...
        store() {
            ...
            if (me.producto_id == 0) {
                alerts.sweetAlert('error', 'Seleccione artículo')
            } else {
                axios.post(url,{
