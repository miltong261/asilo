                        ...
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"> <i class="fas fa-calendar-alt"></i> Fecha compra</th>
                            ...
                            <tbody>
                                 <tr >
                                    ...
                                    <td class="text-center">
                                        <button type="button" @click="openModal('update', compras)" class="btn rounded-circle btn-warning mb-2"> <i class="fas fa-sync-alt"></i></button>
                    ...
                    <div class="form-group row col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label> <i class="fas fa-calendar-alt"></i> Fecha compra</label>
                               <input type="date" class="form-control" name="fecha_compra" v-model="fecha_compra" placeholder="fecha_nacimiento">              
                          </div>
                        </div>
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="documento" v-model="documento" placeholder="Documento">             
                        ...
                        <table class="table table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"> <i class="fas fa-tags"></i> Costo</th>
                                    <th class="text-center"> <i class="fas fa-money-bill-alt"></i> Subtotal</th>
                            ...
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td> 1 </td>
                                    <td class="text-center">
                                        <button class="btn rounded-circle btn-eliminar"> <i class="fa fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
