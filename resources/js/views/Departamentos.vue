                        ...
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"><i class="fas fa-flag"></i> Nombre</th>
                                    <th class="text-center"><i class="fas fa-cogs"></i> Actualizar</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(departamento, index) in lista_departamentos" :key="departamento.id">
                                    <td v-text="index+1" class="text-center"></td>
                                    <td v-text="departamento.nombre" class="text-center"></td>
                                    <td class="text-center">
                                            <button type="button" @click="openModal('update', departamento)" class="btn btn-warning mb-2 mr-2 rounded-circle"> <i class="fas fa-sync-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="modal-body">
                        <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate action="javascript:void(0)">
                            <div class="form-group">
                                <label class="text-dark" for="nombre"><i class="fas fa-flag"></i> Nombre</label>
                                <input  @keyup.enter="store()" type="text" v-model="nombre" class="form-control" :class="hasError('nombre') ? 'is-invalid' : ''" name="nombre" placeholder="Ingrese departamento...">
